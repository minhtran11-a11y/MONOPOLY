...
window.createCornerLandmarks = createCornerLandmarks; // LEGACY-BRIDGE

export { createCornerLandmarks };
window.makeMat = makeMat; // LEGACY-BRIDGE
window.buildKhueVanCac = buildKhueVanCac; // LEGACY-BRIDGE
window.buildOnePillarPagoda = buildOnePillarPagoda; // LEGACY-BRIDGE
window.buildMausoleum = buildMausoleum; // LEGACY-BRIDGE
window.buildDragonHouse = buildDragonHouse; // LEGACY-BRIDGE
window.placeAt = placeAt; // LEGACY-BRIDGE
