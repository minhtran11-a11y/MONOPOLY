...
function _initUIManager() {
    ...
    if (btnBuildMenu) {
        btnBuildMenu.onclick = () => {
            playClick();
            if (window.buildSubmenu) {
                if (window.buildSubmenu.classList.contains('hidden')) {
                    renderBuildMenu();
                    window.buildSubmenu.classList.remove('hidden');
                } else {
                    window.buildSubmenu.classList.add('hidden');
                }
            }
        };
    }
